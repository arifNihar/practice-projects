                ...
                <tbody>
                    <?php $__currentLoopData = array_slice($fakers, 0, 9); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="intro-x">
                            ...
                            <td class="w-40 !py-4">
                                <a href="" class="underline decoration-dotted whitespace-nowrap"><?php echo e('#INV-' . $faker['totals'][0] . '807556'); ?></a>
                            </td>
                            <td class="w-40">
                            ...
                            <td class="text-center">
                                <div class="flex items-center justify-center whitespace-nowrap <?php echo e($faker['true_false'][0] ? 'text-success' : 'text-pending'); ?>">
                                    <i data-lucide="check-square" class="w-4 h-4 mr-2"></i> <?php echo e($faker['true_false'][0] ? 'Completed' : 'Pending Payment'); ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Stock-Modren-ui\resources\views/pages/transaction-list.blade.php ENDPATH**/ ?>