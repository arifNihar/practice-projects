                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                <div class="col-span-12 2xl:col-span-6">
                                    <div>
                                        ...
                                        <input id="update-profile-form-1" type="text" class="form-control" placeholder="Input text" value="<?php echo e($fakers[0]['users'][0]['name']); ?>" disabled>
                                    </div>
                                    <div class="mt-3">
                        ...
                        <div class="w-52 mx-auto xl:mr-0 xl:ml-6">
                            <div class="border-2 border-dashed shadow-sm border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                <div class="h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                    <img class="rounded-md" alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['photos'][0])); ?>">
                    ...
                    <div class="grid grid-cols-12 gap-x-5">
                        <div class="col-span-12 xl:col-span-6">
                            <div>
                                ...
                                <input id="update-profile-form-6" type="text" class="form-control" placeholder="Input text" value="<?php echo e($fakers[0]['users'][0]['email']); ?>" disabled>
                            </div>
                            <div class="mt-3">
                                <label for="update-profile-form-7" class="form-label">Name</label>
                                <input id="update-profile-form-7" type="text" class="form-control" placeholder="Input text" value="<?php echo e($fakers[0]['users'][0]['name']); ?>" disabled>
                            </div>
                            <div class="mt-3">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Entertech-Stock-Profile\resources\views/pages/update-profile.blade.php ENDPATH**/ ?>