        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5">
                    <img alt="Icewall Tailwind HTML Admin Template" class="w-6" src="<?php echo e(asset('build/assets/images/logo.svg')); ?>">
                    <span class="text-white text-lg ml-3">
                        Enigma
                    </span>
                </a>
                <div class="my-auto">
                    <img alt="Icewall Tailwind HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="<?php echo e(asset('build/assets/images/illustration.svg')); ?>">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhammadrizkia/Desktop/Projects/midone-laravel/enigma-laravel/resources/views/login/main.blade.php ENDPATH**/ ?>