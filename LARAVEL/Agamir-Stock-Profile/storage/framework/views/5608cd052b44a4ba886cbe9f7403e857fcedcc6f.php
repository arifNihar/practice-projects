<?php $__env->startSection('subhead'); ?>
    <title>Upload Client Limit File - Entertech</title>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y box col-span-12 2xl:col-span-6 bg-primary">
            <div class="flex flex-row items-start p-5">
                <h2 class="text-xl font-medium items-start font-semibold text-white">All Client Limit Uploaded File.</h2>
            </div>
        </div>
            ...
            <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                ...
                <div class="w-full sm:w-auto flex">
                    <button class="btn btn-primary shadow-md mr-2">
                        ...
                        <span>Upload Client Limit Files <br />
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Entertech-Stock-Profile\resources\views/pages/admin_panel/upload_file/client_limit.blade.php ENDPATH**/ ?>