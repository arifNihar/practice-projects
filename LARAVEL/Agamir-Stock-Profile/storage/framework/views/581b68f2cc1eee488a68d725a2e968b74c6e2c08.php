                    ...
                    <div class="preview">
                        <div class="mx-6 pb-8">
                            <div class="fade-mode">
                                ...
                                <div class="h-64 px-2">
                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[1]['images'][1])); ?>" />
                                    </div>
                                </div>
                                <div class="h-64 px-2">
                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[2]['images'][2])); ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Entertech-Stock-Profile\resources\views/pages/slider.blade.php ENDPATH**/ ?>