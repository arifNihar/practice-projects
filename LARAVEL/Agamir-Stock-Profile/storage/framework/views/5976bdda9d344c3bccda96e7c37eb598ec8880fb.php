        ...
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content bg-primary text-white">
                <li class="p-2">
                    ...
                    <div class="text-xs text-white/70 mt-0.5 dark:text-slate-500"><?php echo e($fakers[0]['jobs'][0]); ?></div>
                </li>
...
<!-- END: Top Bar -->
<?php /**PATH /Users/muhammadrizkia/Desktop/Projects/midone-laravel/rubick-laravel/resources/views////layout/components/top-bar.blade.php ENDPATH**/ ?>