<?php $__env->startSection('subhead'); ?>
    <title>B.O Accounts - Entertech</title>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody class="table-hover">
                                        <tr>
                                            ...
                                            <td class="text-left !px-[0.5rem] !py-[0.75rem] table-report__action w-56">
                ...
                <div class="modal-content">
                    <div class="modal-body p-0">
                        <div class="p-5 text-center">
                            ...
                            <div class="text-slate-500 mt-2">Do you really want to be delete B.O account? <br>This process cannot be undone.</div>
                        </div>
                ...
                <div class="modal-content">
                    <div class="modal-body p-0">
                        <div class="p-5 text-center">
                            ...
                            <div class="text-3xl mt-5">Are you sure?</div>
                            <div class="text-slate-500 mt-2">Do you really want to Edit this B.O account Info? <br>This process cannot be undone.</div>
                        </div>
                        <div class="px-5 pb-8 text-center">
                            <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-24 mr-1">Cancel</button>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeman/Downloads/Entertech-Stock-Profile/resources/views/pages/admin_panel/bo/bo_account.blade.php ENDPATH**/ ?>