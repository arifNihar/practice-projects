            ...
            <div class="intro-y inbox box mt-5">
                ...
                <div class="overflow-x-auto sm:overflow-x-visible">
                    <?php $__currentLoopData = $fakers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="intro-y">
                            <div class="inbox__item<?php echo e($faker['true_false'][0] ? ' inbox__item--active' : ''); ?> inline-block sm:block text-slate-600 dark:text-slate-500 bg-slate-100 dark:bg-darkmode-400/70 border-b border-slate-200/60 dark:border-darkmode-400">
                                <div class="flex px-5 py-3">
                                    <div class="w-72 flex-none flex items-center mr-5">
                                        <input class="form-check-input flex-none" type="checkbox" <?php echo e(!$faker['true_false'][0] ? 'checked' : ''); ?>>
                                        ...
                                        <div class="inbox__item--sender truncate ml-3"><?php echo e($faker['users'][0]['name']); ?></div>
                                    </div>
                                    <div class="w-64 sm:w-auto truncate">
                                        <span class="inbox__item--highlight"><?php echo e($faker['news'][0]['super_short_content']); ?></span> <?php echo e($faker['news'][0]['short_content']); ?>

                                    </div>
                                    <div class="inbox__item--time whitespace-nowrap ml-auto pl-10"><?php echo e($faker['times'][0]); ?></div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Entertech-Stock-Profile\resources\views/pages/inbox.blade.php ENDPATH**/ ?>