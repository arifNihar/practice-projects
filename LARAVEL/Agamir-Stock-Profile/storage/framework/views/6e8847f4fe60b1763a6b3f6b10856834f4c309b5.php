            ...
            <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
                <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 px-5 py-4">
                    ...
                    <div class="ml-3 mr-auto">
                        ...
                        <div class="flex text-slate-500 truncate text-xs mt-0.5">
                            <a class="text-primary inline-block truncate" href=""><?php echo e($faker['products'][0]['category']); ?></a> <span class="mx-1">•</span> <?php echo e($faker['formatted_times'][0]); ?>
                ...
                <div class="p-5">
                    <div class="h-40 2xl:h-56 image-fit">
                        <img alt="Midone - HTML Admin Template" class="rounded-md" src="<?php echo e(asset('build/assets/images/' . $faker['images'][0])); ?>">
                    </div>
                    <a href="" class="block font-medium text-base mt-5"><?php echo e($faker['news'][0]['title']); ?></a>
                    <div class="text-slate-600 dark:text-slate-500 mt-2"><?php echo e($faker['news'][0]['short_content']); ?></div>
                </div>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Entertech-Stock-Profile\resources\views/pages/blog-layout-1.blade.php ENDPATH**/ ?>