                    ...
                    <div class="dropdown">
                        <div class="dropdown-toggle btn w-full btn-outline-secondary dark:bg-darkmode-800 dark:border-darkmode-800 flex items-center justify-start" role="button" aria-expanded="false" data-tw-toggle="dropdown">
                            <div class="w-6 h-6 image-fit mr-3">
                                <img class="rounded" alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['photos'][0])); ?>">
                            </div>
                            <div class="truncate"><?php echo e($fakers[0]['users'][0]['name']); ?></div>
                                    ...
                                    <li>
                                        <a href="javascript:;" class="dropdown-item">
                                            <div class="w-6 h-6 absolute image-fit mr-3">
                                                <img class="rounded" alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $faker['photos'][0])); ?>">
                                            </div>
                                            <div class="ml-8 pl-1"><?php echo e($faker['users'][0]['name']); ?></div>
                                        </a>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Entertech-Stock-Profile\resources\views/pages/post.blade.php ENDPATH**/ ?>