            ...
            <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="intro-y">
                                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $faker['photos'][0])); ?>">
                                    </div>
                                    <div class="ml-4 mr-auto">
                                        <div class="font-medium"><?php echo e($faker['users'][0]['name']); ?></div>
                                        <div class="text-slate-500 text-xs mt-0.5"><?php echo e($faker['dates'][0]); ?></div>
                                    </div>
                ...
                <div class="col-span-12 lg:col-span-6 mt-6">
                    <div class="box p-8 relative overflow-hidden bg-primary intro-y">
                        ...
                        <img class="hidden sm:block absolute top-0 right-0 w-2/5 -mt-3 mr-2" alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/woman-illustration.svg')); ?>">
                    </div>
                </div>
                <!-- END: Ads 1 -->
                <!-- BEGIN: Ads 2 -->
                <div class="col-span-12 lg:col-span-6 mt-6">
                    <div class="box p-8 relative overflow-hidden intro-y">
                        ...
                        <img class="hidden sm:block absolute top-0 right-0 w-1/2 mt-1 -mr-12" alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/phone-illustration.svg')); ?>">
                    </div>
                </div>
                <!-- END: Ads 2 -->
                                        ...
                                        <td class="w-40">
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="<?php echo e(asset('build/assets/images/' . $faker['images'][0])); ?>" title="Uploaded at <?php echo e($faker['dates'][0]); ?>">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="<?php echo e(asset('build/assets/images/' . $faker['images'][1])); ?>" title="Uploaded at <?php echo e($faker['dates'][1]); ?>">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="<?php echo e(asset('build/assets/images/' . $faker['images'][2])); ?>" title="Uploaded at <?php echo e($faker['dates'][2]); ?>">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
            ...
            <div class="2xl:border-l -mb-10 pb-10">
                <div class="2xl:pl-6 grid grid-cols-12 gap-x-6 2xl:gap-x-0 gap-y-6">
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 mt-3">
                        ...
                        <div class="mt-5 relative before:block before:absolute before:w-px before:h-[85%] before:bg-slate-200 before:dark:bg-darkmode-400 before:ml-5 before:mt-5">
                            <div class="intro-x relative flex items-center mb-3">
                                <div class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[9]['photos'][0])); ?>">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
                                        <div class="font-medium"><?php echo e($fakers[9]['users'][0]['name']); ?></div>
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[8]['photos'][0])); ?>">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
                                        <div class="font-medium"><?php echo e($fakers[8]['users'][0]['name']); ?></div>
                                        <div class="text-xs text-slate-500 ml-auto">07:00 PM</div>
                                    </div>
                                    <div class="text-slate-500">
                                        <div class="mt-1">Added 3 new photos</div>
                                        <div class="flex mt-2">
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="<?php echo e($fakers[0]['products'][0]['name']); ?>">
                                                <img alt="Midone - HTML Admin Template" class="rounded-md border border-white" src="<?php echo e(asset('build/assets/images/' . $fakers[8]['images'][0])); ?>">
                                            </div>
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="<?php echo e($fakers[1]['products'][0]['name']); ?>">
                                                <img alt="Midone - HTML Admin Template" class="rounded-md border border-white" src="<?php echo e(asset('build/assets/images/' . $fakers[8]['images'][1])); ?>">
                                            </div>
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="<?php echo e($fakers[2]['products'][0]['name']); ?>">
                                                <img alt="Midone - HTML Admin Template" class="rounded-md border border-white" src="<?php echo e(asset('build/assets/images/' . $fakers[8]['images'][2])); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[7]['photos'][0])); ?>">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
                                        <div class="font-medium"><?php echo e($fakers[7]['users'][0]['name']); ?></div>
                                        <div class="text-xs text-slate-500 ml-auto">07:00 PM</div>
                                    </div>
                                    <div class="text-slate-500 mt-1">Has changed <a class="text-primary" href=""><?php echo e($fakers[7]['products'][0]['name']); ?></a> price and description</div>
                                </div>
                            </div>
                            <div class="intro-x relative flex items-center mb-3">
                                <div class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[6]['photos'][0])); ?>">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
                                        <div class="font-medium"><?php echo e($fakers[6]['users'][0]['name']); ?></div>
                                        <div class="text-xs text-slate-500 ml-auto">07:00 PM</div>
                                    </div>
                                    <div class="text-slate-500 mt-1">Has changed <a class="text-primary" href=""><?php echo e($fakers[6]['products'][0]['name']); ?></a> description</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 mt-3">
                        ...
                        <div class="mt-5">
                            <?php $__currentLoopData = array_slice($fakers, 0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="intro-x">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhammadrizkia/Desktop/Projects/midone-laravel/rubick-laravel/resources/views/pages/dashboard-overview-2.blade.php ENDPATH**/ ?>