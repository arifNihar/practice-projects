<?php $__env->startSection('subhead'); ?>
    <title>Deposite Request - Entertech</title>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y box col-span-12 2xl:col-span-6 bg-primary">
            <div class="flex flex-row items-start p-5">
                <h2 class="text-xl font-medium items-start font-semibold text-white">All Deposite Request</h2>
            </div>
        </div>
                            ...
                            <table class="table table-hover">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-center !px-[0.5rem] !py-[0.75rem]">Deposit Date</th>
                                        <th class="text-center !px-[0.5rem] !py-[0.75rem]">Deposit Amount</th>
                                        <th class="text-center !px-[0.5rem] !py-[0.75rem]">Request Date</th>

                                        <th class="text-center !px-[0.5rem] !py-[0.75rem]">Status</th>
                                         <th class="text-center !px-[0.5rem] !py-[0.75rem]">Attachments</th>
                                ...
                                <tbody class="table-hover">
                                    <tr>
                                        ...
                                        <td class="text-center !px-[0.5rem] !py-[0.75rem]">22th December 2022</td>
                                        ...
                                        <td>
                                            <div class="flex justify-center">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Entertech - Stock Profile" class="tooltip rounded-5" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['images'][1])); ?>" title="Uploaded attachment">
                                                </div>
                                            </div>
                                        </td>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeman/Desktop/practice-projects/LARAVEL/Agamir-Stock-Profile/resources/views/pages/admin_panel/transaction/deposite_request.blade.php ENDPATH**/ ?>