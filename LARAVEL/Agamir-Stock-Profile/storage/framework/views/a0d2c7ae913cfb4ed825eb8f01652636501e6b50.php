...
<?php $__env->startSection('subcontent'); ?>
    <div class="intro-y news xl:w-3/5 p-5 box mt-8">
        <!-- BEGIN: Blog Layout -->
        <h2 class="intro-y font-medium text-xl sm:text-2xl"><?php echo e($fakers[0]['news'][0]['title']); ?></h2>
        <div class="intro-y text-slate-600 dark:text-slate-500 mt-3 text-xs sm:text-sm">
            <?php echo e($fakers[0]['dates'][0]); ?> <span class="mx-1">•</span> <a class="text-primary" href=""><?php echo e($fakers[0]['products'][0]['category']); ?></a> <span class="mx-1">•</span> 7 Min read
        </div>
        <div class="intro-y mt-6">
            <div class="news__preview image-fit">
                <img alt="Midone - HTML Admin Template" class="rounded-md" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['images'][0])); ?>">
            </div>
        </div>
        <div class="intro-y flex relative pt-16 sm:pt-6 items-center pb-6">
            ...
            <div class="intro-x flex mr-3">
                <div class="intro-x w-8 h-8 sm:w-10 sm:h-10 image-fit">
                    <img alt="Midone - HTML Admin Template" class="rounded-full border border-white zoom-in tooltip" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['photos'][0])); ?>" title="<?php echo e($fakers[0]['users'][0]['name']); ?>">
                </div>
                <div class="intro-x w-8 h-8 sm:w-10 sm:h-10 image-fit -ml-4">
                    <img alt="Midone - HTML Admin Template" class="rounded-full border border-white zoom-in tooltip" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['photos'][1])); ?>" title="<?php echo e($fakers[0]['users'][1]['name']); ?>">
                </div>
                <div class="intro-x w-8 h-8 sm:w-10 sm:h-10 image-fit -ml-4">
                    <img alt="Midone - HTML Admin Template" class="rounded-full border border-white zoom-in tooltip" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['photos'][2])); ?>" title="<?php echo e($fakers[0]['users'][2]['name']); ?>">
                </div>
            </div>
            <div class="absolute sm:relative -mt-12 sm:mt-0 w-full flex text-slate-600 dark:text-slate-500 text-xs sm:text-sm">
                <div class="intro-x mr-1 sm:mr-3">
                    Comments: <span class="font-medium"><?php echo e($fakers[0]['totals'][0]); ?></span>
                </div>
                <div class="intro-x mr-1 sm:mr-3">
                    Views: <span class="font-medium"><?php echo e($fakers[0]['totals'][1]); ?>k</span>
                </div>
                <div class="intro-x sm:mr-3 ml-auto">
                    Likes: <span class="font-medium"><?php echo e($fakers[0]['totals'][2]); ?>k</span>
                </div>
            </div>
        ...
        <div class="intro-y text-justify leading-relaxed">
            <p class="mb-5"><?php echo e($fakers[1]['news'][0]['content']); ?></p>
            <p class="mb-5"><?php echo e($fakers[2]['news'][0]['content']); ?></p>
            <p><?php echo e($fakers[3]['news'][0]['content']); ?></p>
        </div>
        <div class="intro-y flex text-xs sm:text-sm flex-col sm:flex-row items-center mt-5 pt-5 border-t border-slate-200/60 dark:border-darkmode-400">
            <div class="flex items-center">
                ...
                <div class="ml-3 mr-auto">
                    <a href="" class="font-medium"><?php echo e($fakers[0]['users'][0]['name']); ?></a>, Author
        ...
        <div class="intro-y mt-5 pb-10">
            <div class="pt-5">
                <div class="flex">
                    ...
                    <div class="ml-3 flex-1">
                        ...
                        <div class="text-slate-500 text-xs sm:text-sm"><?php echo e($fakers[0]['formatted_times'][0]); ?></div>
                        <div class="mt-2"><?php echo e($fakers[0]['news'][0]['short_content']); ?></div>
                    </div>
                </div>
            </div>
            <div class="mt-5 pt-5 border-t border-slate-200/60 dark:border-darkmode-400">
                <div class="flex">
                    <div class="w-10 h-10 sm:w-12 sm:h-12 flex-none image-fit">
                        <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['photos'][1])); ?>">
                    </div>
                    <div class="ml-3 flex-1">
                        <div class="flex items-center">
                            <a href="" class="font-medium"><?php echo e($fakers[0]['users'][1]['name']); ?></a>
                            <a href="" class="ml-auto text-xs text-slate-500">Reply</a>
                        </div>
                        <div class="text-slate-500 text-xs sm:text-sm"><?php echo e($fakers[1]['formatted_times'][0]); ?></div>
                        <div class="mt-2"><?php echo e($fakers[1]['news'][0]['short_content']); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Entertech-Stock-Profile\resources\views/pages/blog-layout-3.blade.php ENDPATH**/ ?>