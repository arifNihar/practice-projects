...
<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar">
        <a href="" class="flex mr-auto">
            <img alt="Midone - HTML Admin Template" class="w-6" src="<?php echo e(asset('build/assets/images/logo.svg')); ?>">
        </a>
                        ...
                        <a href="<?php echo e(isset($menu['route_name']) ? route($menu['route_name'], $menu['params']) : 'javascript:;'); ?>" class="<?php echo e($first_level_active_index == $menuKey ? 'menu menu--active' : 'menu'); ?>">
                            ...
                            <div class="menu__title">
                                ...
                                <?php if(isset($menu['sub_menu'])): ?>
                                    <i data-lucide="chevron-down" class="menu__sub-icon <?php echo e($first_level_active_index == $menuKey ? 'transform rotate-180' : ''); ?>"></i>
                                <?php endif; ?>
                            </div>
                        </a>
                        <?php if(isset($menu['sub_menu'])): ?>
                            <ul class="<?php echo e($first_level_active_index == $menuKey ? 'menu__sub-open' : ''); ?>">
                                <?php $__currentLoopData = $menu['sub_menu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subMenuKey => $subMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="<?php echo e(isset($subMenu['route_name']) ? route($subMenu['route_name'], $subMenu['params']) : 'javascript:;'); ?>" class="<?php echo e($second_level_active_index == $subMenuKey ? 'menu menu--active' : 'menu'); ?>">
                                            <div class="menu__icon">
                                            ...
                                            <div class="menu__title">
                                                ...
                                                <?php if(isset($subMenu['sub_menu'])): ?>
                                                    <i data-lucide="chevron-down" class="menu__sub-icon <?php echo e($second_level_active_index == $subMenuKey ? 'transform rotate-180' : ''); ?>"></i>
                                                <?php endif; ?>
                                            </div>
                                        </a>
                                        <?php if(isset($subMenu['sub_menu'])): ?>
...
<!-- END: Mobile Menu -->
<?php /**PATH /Users/muhammadrizkia/Desktop/Projects/midone-laravel/rubick-laravel/resources/views////layout/components/mobile-menu.blade.php ENDPATH**/ ?>