            ...
            <div class="tab-content">
                <div id="chats" class="tab-pane active" role="tabpanel" aria-labelledby="chats-tab">
                    <div class="pr-1">
                        <div class="box px-5 pt-5 pb-5 lg:pb-0 mt-5">
                            ...
                            <div class="overflow-x-auto scrollbar-hidden">
                                <div class="flex mt-5">
                                    <?php $__currentLoopData = array_slice($fakers, 0, 10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="" class="w-10 mr-4 cursor-pointer">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full">
                                                <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('build/assets/images/' . $faker['photos'][0])); ?>">
                                                <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                                            </div>
                                            <div class="text-xs text-slate-500 truncate text-center mt-2"><?php echo e($faker['users'][0]['name']); ?></div>
                                        </a>
                    ...
                    <div class="chat__chat-list overflow-y-auto scrollbar-hidden pr-1 pt-1 mt-4">
                        <?php $__currentLoopData = array_slice($fakers, 0, 10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $faker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 <?php echo e($key ? 'mt-5' : ''); ?>">
                                ...
                                <div class="ml-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;" class="font-medium"><?php echo e($faker['users'][0]['name']); ?></a>
                                        <div class="text-xs text-slate-400 ml-auto"><?php echo e($faker['times'][0]); ?></div>
                                    </div>
                                    <div class="w-full truncate text-slate-500 mt-0.5"><?php echo e($faker['news'][0]['short_content']); ?></div>
                                </div>
                                <?php if($faker['true_false'][0]): ?>
                                    <div class="w-5 h-5 flex items-center justify-center absolute top-0 right-0 text-xs text-white rounded-full bg-primary font-medium -mt-1 -mr-1"><?php echo e($faker['notification_count']); ?></div>
                                <?php endif; ?>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                ...
                <div id="friends" class="tab-pane" role="tabpanel" aria-labelledby="friends-tab">
                    ...
                    <div class="chat__user-list overflow-y-auto scrollbar-hidden pr-1 pt-1">
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['photos'][0])); ?>">
                                <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                            </div>
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center">
                                    <a href="" class="font-medium"><?php echo e($fakers[0]['users'][0]['name']); ?></a>
                                </div>
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('build/assets/images/' . $fakers[1]['photos'][0])); ?>">
                                <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                            </div>
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center">
                                    <a href="" class="font-medium"><?php echo e($fakers[1]['users'][0]['name']); ?></a>
                                </div>
                                <div class="w-full truncate text-slate-500 mt-0.5">Last seen 2 hours ago</div>
                            </div>
                            <div class="dropdown ml-auto">
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('build/assets/images/' . $fakers[2]['photos'][0])); ?>">
                                <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                            </div>
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center">
                                    <a href="" class="font-medium"><?php echo e($fakers[2]['users'][0]['name']); ?></a>
                                </div>
                                <div class="w-full truncate text-slate-500 mt-0.5">Last seen 2 hours ago</div>
                            </div>
                            <div class="dropdown ml-auto">
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('build/assets/images/' . $fakers[3]['photos'][0])); ?>">
                                <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                            </div>
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center">
                                    <a href="" class="font-medium"><?php echo e($fakers[3]['users'][0]['name']); ?></a>
                                </div>
                                <div class="w-full truncate text-slate-500 mt-0.5">Last seen 2 hours ago</div>
                            </div>
                            <div class="dropdown ml-auto">
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="Midone - HTML Admin Template" class="rounded-full" src="<?php echo e(asset('build/assets/images/' . $fakers[4]['photos'][0])); ?>">
                                <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                            </div>
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center">
                                    <a href="" class="font-medium"><?php echo e($fakers[4]['users'][0]['name']); ?></a>
                                </div>
                                <div class="w-full truncate text-slate-500 mt-0.5">Last seen 2 hours ago</div>
                            </div>
                            <div class="dropdown ml-auto">
                    ...
                    <div class="pr-1">
                        <div class="box px-5 py-10 mt-5">
                            <div class="w-20 h-20 flex-none image-fit rounded-full overflow-hidden mx-auto">
                                <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['photos'][0])); ?>">
                            </div>
                            <div class="text-center mt-3">
                                <div class="font-medium text-lg"><?php echo e($fakers[0]['users'][0]['name']); ?></div>
                        ...
                        <div class="box p-5 mt-5">
                            ...
                            <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 py-5">
                                <div>
                                    ...
                                    <div class="mt-1"><?php echo e($fakers[0]['users'][0]['email']); ?></div>
                                </div>
                            ...
                            <div class="flex items-center pt-5">
                                <div>
                                    ...
                                    <div class="mt-1"><?php echo e($fakers[0]['dates'][0]); ?></div>
                                </div>
            ...
            <div class="chat__box box">
                ...
                <div class="hidden h-full flex flex-col">
                    <div class="flex flex-col sm:flex-row border-b border-slate-200/60 dark:border-darkmode-400 px-5 py-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 mr-auto">
                                <div class="font-medium text-base"><?php echo e($fakers[0]['users'][0]['name']); ?></div>
                    ...
                    <div class="overflow-y-scroll scrollbar-hidden px-5 pt-5 flex-1">
                        ...
                        <div class="chat__box__text-box flex items-end float-left mb-4">
                            ...
                            <div class="bg-slate-100 dark:bg-darkmode-400 px-4 py-3 text-slate-500 rounded-r-md rounded-t-md">
                                <?php echo e($fakers[0]['users'][0]['name']); ?> is typing
                ...
                <div class="h-full flex items-center">
                    <div class="mx-auto text-center">
                        ...
                        <div class="mt-3">
                            <div class="font-medium">Hey, <?php echo e($fakers[0]['users'][0]['name']); ?>!</div>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Entertech-Stock-Profile\resources\views/pages/chat.blade.php ENDPATH**/ ?>