        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5  mb-5">
                    <img alt="Entertech" class="w-25" src="<?php echo e(asset('build/assets/images/entertech.png')); ?>">
                    <span class="text-white text-lg ml-3">
                        STOCK MARKET PROFILE
                    </span>
                </a>
                <div class="my-auto">
                    <img alt="Entertech" class="-intro-x w-1/2 -mt-16" src="<?php echo e(asset('build/assets/images/illustration.svg')); ?>">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeman/Downloads/Entertech-Stock-Profile/resources/views/login/main.blade.php ENDPATH**/ ?>