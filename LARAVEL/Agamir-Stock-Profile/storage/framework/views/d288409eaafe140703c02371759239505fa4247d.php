        ...
        <div class="col-span-12 lg:col-span-3 2xl:col-span-3 flex lg:block flex-col-reverse">
            <div class="intro-y box mt-5 lg:mt-0">
                ...
                <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                    <a class="flex items-center text-[16px] text-primary font-medium" href="">
                        <i data-lucide="newspaper" class="w-4 h-4 mr-2"></i>News
                    </a>
                    <a class="flex items-center text-[16px] mt-5" href="">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Stock-Modren-ui\resources\views/pages/admin_panel/market_data/market_data.blade.php ENDPATH**/ ?>