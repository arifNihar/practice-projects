                                            ...
                                            <div class="center-mode">
                                                <div class="h-56 px-2">
                                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                                        <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['images'][0])); ?>" />
                                                    </div>
                                                </div>
                                                <div class="h-56 px-2">
                                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                                        <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['images'][1])); ?>" />
                                                    </div>
                                                </div>
                                                <div class="h-56 px-2">
                                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                                        <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['images'][2])); ?>" />
                                                    </div>
                                                </div>
                                                <div class="h-56 px-2">
                                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                                        <img alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $fakers[0]['images'][3])); ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Entertech-Stock-Profile\resources\views/pages/modal.blade.php ENDPATH**/ ?>