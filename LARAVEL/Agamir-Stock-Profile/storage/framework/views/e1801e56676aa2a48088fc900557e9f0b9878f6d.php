                                ...
                                <div class="grid grid-cols-10 gap-5 pl-4 pr-5">
                                    <?php $__currentLoopData = array_slice($fakers, 0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-span-5 md:col-span-2 h-28 relative image-fit cursor-pointer zoom-in">
                                            <img class="rounded-md" alt="Midone - HTML Admin Template" src="<?php echo e(asset('build/assets/images/' . $faker['images'][0])); ?>">
                            ...
                            <div class="w-full mt-3 xl:mt-0 flex-1">
                                <select id="category" class="form-select">
                                    <?php $__currentLoopData = array_slice($fakers, 0, 9); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($faker['categories'][0]['name']); ?>"><?php echo e($faker['categories'][0]['name']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                            ...
                            <div class="w-full mt-3 xl:mt-0 flex-1">
                                <select id="subcategory" data-placeholder="Etalase" class="tom-select w-full" multiple>
                                    <?php $__currentLoopData = array_slice($fakers, 0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option selected value="<?php echo e($faker['categories'][0]['name']); ?>"><?php echo e($faker['categories'][0]['name']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Stock-Modren-ui\resources\views/pages/add-product.blade.php ENDPATH**/ ?>