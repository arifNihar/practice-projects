...
<?php $__env->startSection('subcontent'); ?>
    ...
    <div class="intro-y grid grid-cols-12 gap-6 mt-5">
        <!-- BEGIN: Blog Layout -->
        <?php $__currentLoopData = array_slice($fakers, 0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="intro-y col-span-12 md:col-span-6 box">
                <div class="h-[320px] before:block before:absolute before:w-full before:h-full before:top-0 before:left-0 before:z-10 before:bg-gradient-to-t before:from-black/90 before:to-black/10 image-fit">
                    <img alt="Midone - HTML Admin Template" class="rounded-t-md" src="<?php echo e(asset('build/assets/images/' . $faker['images'][0])); ?>">
                    <div class="absolute w-full flex items-center px-5 pt-6 z-10">
                        ...
                        <div class="ml-3 text-white mr-auto">
                            <a href="" class="font-medium"><?php echo e($faker['users'][0]['name']); ?></a>
                            <div class="text-xs mt-0.5"><?php echo e($faker['formatted_times'][0]); ?></div>
                        </div>
                    ...
                    <div class="absolute bottom-0 text-white px-5 pb-6 z-10">
                        <span class="bg-white/20 px-2 py-1 rounded"><?php echo e($faker['products'][0]['category']); ?></span>
                        <a href="" class="block font-medium text-xl mt-3"><?php echo e($faker['news'][0]['title']); ?></a>
                    </div>
                </div>
                <div class="p-5 text-slate-600 dark:text-slate-500"><?php echo e($faker['news'][0]['short_content']); ?></div>
                <div class="flex items-center px-5 py-3 border-t border-slate-200/60 dark:border-darkmode-400">
                    ...
                    <div class="intro-x flex mr-2">
                        <div class="intro-x w-8 h-8 image-fit">
                            <img alt="Midone - HTML Admin Template" class="rounded-full border border-white zoom-in tooltip" src="<?php echo e(asset('build/assets/images/' . $faker['photos'][0])); ?>" title="<?php echo e($faker['users'][0]['name']); ?>">
                        </div>
                        <div class="intro-x w-8 h-8 image-fit -ml-4">
                            <img alt="Midone - HTML Admin Template" class="rounded-full border border-white zoom-in tooltip" src="<?php echo e(asset('build/assets/images/' . $faker['photos'][1])); ?>" title="<?php echo e($faker['users'][1]['name']); ?>">
                        </div>
                        <div class="intro-x w-8 h-8 image-fit -ml-4">
                            <img alt="Midone - HTML Admin Template" class="rounded-full border border-white zoom-in tooltip" src="<?php echo e(asset('build/assets/images/' . $faker['photos'][2])); ?>" title="<?php echo e($faker['users'][2]['name']); ?>">
                        </div>
                    </div>
                ...
                <div class="px-5 pt-3 pb-5 border-t border-slate-200/60 dark:border-darkmode-400">
                    <div class="w-full flex text-slate-500 text-xs sm:text-sm">
                        <div class="mr-2">
                            Comments: <span class="font-medium"><?php echo e($faker['totals'][0]); ?></span>
                        </div>
                        <div class="mr-2">
                            Views: <span class="font-medium"><?php echo e($faker['totals'][1]); ?>k</span>
                        </div>
                        <div class="ml-auto">
                            Likes: <span class="font-medium"><?php echo e($faker['totals'][2]); ?>k</span>
                        </div>
                    </div>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Entertech-Stock-Profile\resources\views/pages/blog-layout-2.blade.php ENDPATH**/ ?>