            ...
            <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4">
                <div class="box">
                    <div class="flex items-start px-5 pt-5">
                        <div class="w-full flex flex-col lg:flex-row items-center">
                            ...
                            <div class="lg:ml-4 text-center lg:text-left mt-3 lg:mt-0">
                                ...
                                <div class="text-slate-500 text-xs mt-0.5"><?php echo e($faker['jobs'][0]); ?></div>
                            </div>
                        </div>
                    ...
                    <div class="text-center lg:text-left p-5">
                        <div><?php echo e($faker['news'][0]['short_content']); ?></div>
                        <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-5">
                            <i data-lucide="mail" class="w-3 h-3 mr-2"></i> <?php echo e($faker['users'][0]['email']); ?>

                        </div>
                        <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-1">
                            <i data-lucide="instagram" class="w-3 h-3 mr-2"></i> <?php echo e($faker['users'][0]['name']); ?>
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Stock-Modren-ui\resources\views/pages/users-layout-3.blade.php ENDPATH**/ ?>