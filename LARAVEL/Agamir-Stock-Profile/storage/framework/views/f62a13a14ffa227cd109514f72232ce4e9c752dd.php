        ...
        <div class="col-span-12 lg:col-span-3 2xl:col-span-3 flex lg:block flex-col-reverse">
            <div class="intro-y box mt-5 lg:mt-0">
                ...
                <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                    <a class="flex items-center text-[16px] font-medium" href="<?php echo e(route('market-news-data')); ?>">
                        <i data-lucide="newspaper" class="w-4 h-4 mr-2"></i>News
                    </a>
                    <a class="flex items-center text-[16px] font-medium mt-5" href="<?php echo e(route('market-events-data')); ?>">
                        <i data-lucide="boxes" class="w-4 h-4 mr-2"></i> Events
                    </a>
                    <a class="flex items-center text-[16px] text-primary font-medium mt-5" href="<?php echo e(route('market-category-data')); ?>">
                        <i data-lucide="file-type-2" class="w-4 h-4 mr-2"></i> Category
                    </a>
                    <a class="flex items-center text-[16px] font-medium mt-5" href="<?php echo e(route('market-industry-data')); ?>">
                        <i data-lucide="factory" class="w-4 h-4 mr-2"></i> Industry Data
                    </a>
                    <a class="flex items-center text-[16px] font-medium mt-5" href="<?php echo e(route('market-company-data')); ?>">
                        ...
                        <table class="table mt-2">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="whitespace-nowrap uppercase text-center">CATEGORY NAME</th>
                                    <th class="whitespace-nowrap uppercase text-center">SHARE MATURITY DURATION</th>
                    ...
                    <div class="modal-content">
                        <div class="modal-body p-0">
                            <div class="p-5 text-center">
                                ...
                                <div class="text-slate-500 mt-2">Do you really want to delete these category data request? <br>This process cannot be undone.</div>
                            </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="px-5 pt-2 pb-5 grid grid-cols-12 gap-4 gap-y-3">
                            <div class="col-span-12 sm:col-span-12">
                                <label for="modal-form-5" class="form-label text-lg font-semibold">SHARE MATURITY DURATION</label>
                                <input id="modal-form-5" type="password" class="form-control" placeholder="">
                            </div>
                        </div>
                        <!-- END: Modal Body -->
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeman/Downloads/Entertech-Stock-Profile/resources/views/pages/admin_panel/market_data/category_data.blade.php ENDPATH**/ ?>