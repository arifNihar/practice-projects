        ...
        <div class="col-span-12 lg:col-span-3 2xl:col-span-3 flex lg:block flex-col-reverse">
            <div class="intro-y box mt-5 lg:mt-0">
                ...
                <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                    ...
                    <a class="flex items-center text-[16px] font-medium mt-5" href="<?php echo e(route('market-category-data')); ?>">
                        <i data-lucide="file-type-2" class="w-4 h-4 mr-2"></i> Category
                    </a>
                    <a class="flex items-center text-[16px] text-primary font-medium mt-5" href="<?php echo e(route('market-industry-data')); ?>">
                        ...
                        <table class="table mt-2">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="whitespace-nowrap uppercase text-center">INDUSTRY NAME</th>
                    ...
                    <div class="modal-content">
                        <div class="modal-body p-0">
                            <div class="p-5 text-center">
                                ...
                                <div class="text-slate-500 mt-2">Do you really want to delete these Industry data request? <br>This process cannot be undone.</div>
                            </div>
            ...
            <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <!-- BEGIN: Modal Body -->
                        <div class="px-5 py-5 grid grid-cols-12 gap-4 gap-y-3">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeman/Downloads/Entertech-Stock-Profile/resources/views/pages/admin_panel/market_data/industry_data.blade.php ENDPATH**/ ?>