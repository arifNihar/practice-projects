...
<?php $__env->startSection('subcontent'); ?>
                    ...
                    <ul class="dropdown-content">
                        <li>
                            <a href="" class="dropdown-item">
                                ...
                                <span class="truncate">INV-0206020 - <?php echo e($fakers[3]['users'][0]['name']); ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="" class="dropdown-item">
                                <i data-lucide="activity" class="w-4 h-4 mr-2"></i>
                                <span class="truncate">INV-0206022 - <?php echo e($fakers[4]['users'][0]['name']); ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="" class="dropdown-item">
                                <i data-lucide="activity" class="w-4 h-4 mr-2"></i>
                                <span class="truncate">INV-0206021 - <?php echo e($fakers[5]['users'][0]['name']); ?></span>
                            </a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="box rounded-md p-3 relative zoom-in">
                            <div class="flex-none relative block before:block before:w-full before:pt-[100%]">
                                <div class="absolute top-0 left-0 w-full h-full image-fit">
                                    <img alt="Midone - HTML Admin Template" class="rounded-md" src="<?php echo e(asset('build/assets/images/' . $faker['foods'][0]['image'])); ?>">
                                </div>
                            </div>
                            <div class="block font-medium text-center truncate mt-3"><?php echo e($faker['foods'][0]['name']); ?></div>
                        </div>
                    </a>
                    ...
                    <div class="box p-2 mt-5">
                        <?php $__currentLoopData = array_slice($fakers, 0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $faker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                                <div class="max-w-[50%] truncate mr-1"><?php echo e($faker['foods'][0]['name']); ?></div>
                                <div class="text-slate-500">x 1</div>
                                <i data-lucide="edit" class="w-4 h-4 text-slate-500 ml-2"></i>
                                <div class="ml-auto font-medium">$<?php echo e($faker['totals'][0]); ?></div>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <div class="box p-5 mt-5">
                        ...
                        <div class="flex items-center border-b border-slate-200 dark:border-darkmode-400 py-5">
                            <div>
                                ...
                                <div class="mt-1"><?php echo e($fakers[0]['users'][0]['name']); ?></div>
                            </div>
    ...
    <div id="add-item-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto"><?php echo e($fakers[0]['foods'][0]['name']); ?></h2>
                </div>
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12">
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Entertech-Stock-Profile\resources\views/pages/point-of-sale.blade.php ENDPATH**/ ?>